...
export const users = mysqlTable("users", {
  ...
  openId: varchar("openId", { length: 64 }), // Opcional - para OAuth futuro
  name: text("name"),
  ...
  appRole: mysqlEnum("appRole", ["socio", "gerente", "consultora", "admin"]).default("consultora").notNull(),
  unitId: int("unitId"),
...
export const posts = mysqlTable("posts", {
  ...
  category: varchar("category", { length: 50 }).default("geral").notNull(), // unidade/categoria
